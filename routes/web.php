...
Route::middleware('auth')->group(function () {
    ...
    Route::post('parser-queue/{incomingReportEmail}/link-machine', [ParserReviewQueueController::class, 'linkMachine'])->middleware('platform_admin')->name('parser-queue.link-machine');
